 ...
 * @param layerId The Layer the tag is associated with
 * @param windowToken The Window the tag is associated with
 * @param taskId The Task the tag is associated with
 */
data class Tag(
    val id: Int,
