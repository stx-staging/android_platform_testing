...
class Region(rects: Array<Rect> = arrayOf()) {
    ...
    companion object {
        ...
        @JsName("SkRegion_kRunTypeSentinel")
        const val SkRegion_kRunTypeSentinel = 0x7FFFFFFF

        @JsName("kRectRegionRuns")
