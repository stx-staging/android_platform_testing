 ...
 */
fun LayerTraceEntry.hasVisibleRegion(
    layerName: String,
 ...
 * @param layerName Name of the layer to search
 */
fun LayerTraceEntry.exists(layerName: String): AssertionResult {
 ...
 * @param layerName Name of the layer to search
 */
fun LayerTraceEntry.isVisible(layerName: String): AssertionResult {
 ...
 * @param layerName Name of the layer to search
 */
fun LayerTraceEntry.coversAtLeastRegion(
 ...
 * @param layerName Name of the layer to search
 */
fun LayerTraceEntry.coversAtMostRegion(testRegion: android.graphics.Region, layerName: String = ""):
    AssertionResult {
    return covers(layerName) { jointRegion ->
...
fun LayerTraceEntry.hasVisibleRegion(
    layerName: String,
    expectedVisibleRegion: android.graphics.Region
): AssertionResult {
    val assertionName = "hasVisibleRegion"
    var reason = "Could not find $layerName"
    for (layer in flattenedLayers) {
