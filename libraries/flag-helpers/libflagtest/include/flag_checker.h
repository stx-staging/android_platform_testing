...
// Calls GTEST_SKIP if the value of any input feature flag doesn't meet
// expected condition. `flag_conditions` is a group of pairs, with each
// pair containing the expected condition and a group of feature flags.
